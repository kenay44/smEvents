...
describe('Service Tests', () => {
    ...
    describe('PersonSmEvent Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(PersonSmEventService);
        ...
        describe('Service methods', () => {
            ...
            it('should return PersonSmEvent', () => {

                let entity: PersonSmEvent;
                service.find(123).subscribe((_entity: PersonSmEvent) => {
                    entity = _entity;
                });
