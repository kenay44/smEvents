...
describe('Service Tests', () => {
    ...
    describe('FamilySmEvent Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(FamilySmEventService);
        ...
        describe('Service methods', () => {
            ...
            it('should return FamilySmEvent', () => {

                let entity: FamilySmEvent;
                service.find(123).subscribe((_entity: FamilySmEvent) => {
                    entity = _entity;
                });
