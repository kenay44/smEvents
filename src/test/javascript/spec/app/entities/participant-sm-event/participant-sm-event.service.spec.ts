...
describe('Service Tests', () => {
    ...
    describe('ParticipantSmEvent Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(ParticipantSmEventService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/participants';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ParticipantSmEvent', () => {

                let entity: ParticipantSmEvent;
                service.find(123).subscribe((_entity: ParticipantSmEvent) => {
                    entity = _entity;
                });
