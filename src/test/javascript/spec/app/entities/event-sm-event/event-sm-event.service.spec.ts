...
describe('Service Tests', () => {
    ...
    describe('EventSmEvent Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(EventSmEventService);
        ...
        describe('Service methods', () => {
            ...
            it('should return EventSmEvent', () => {

                let entity: EventSmEvent;
                service.find(123).subscribe((_entity: EventSmEvent) => {
                    entity = _entity;
                });
