package org.sm.events.config;

import org.sm.events.security.*;
import org.sm.events.security.jwt.*;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        .and()
            ...
            .antMatchers(HttpMethod.DELETE, "/api/participants/*/child").authenticated()
            .antMatchers(HttpMethod.GET, "/api/events/**").authenticated()
            .antMatchers("/api/profile-info").permitAll()
            .antMatchers("/api/people/family/**").authenticated()
            .antMatchers("/api/participants/sign/children/**").authenticated()
            .antMatchers("/api/events/published").permitAll()
